    ...
    <div className="bg-white text-black font-sans antialiased">
      ...
      <div className="relative w-full h-screen overflow-hidden pt-16 md:pt-20">
        ...
        {(statsLoading || statsResult || statsError) && (
          <div className="absolute top-20 md:top-24 right-4 z-[998] bg-white rounded-xl shadow-2xl border border-umbrella-border max-w-sm w-full overflow-hidden">
        ...
        {/* ─── Sidebar ─── */}
        <div className="absolute top-16 md:top-20 left-0 z-[999]">
          <div className="h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)] w-72 bg-umbrella-dark flex flex-col">
            {/* Header */}
            ...
            <div className="px-5 py-3 border-t border-white/10">
              <p className="text-[9px] text-white/25 leading-relaxed">
                ...
                Projet LDN Bénin — Financement FEM/PNUE
              </p>
            </div>
          </div>
        </div>
